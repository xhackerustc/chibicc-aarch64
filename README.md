...
This is a fork of [rui314/chibicc](https://github.com/rui314/chibicc) ported to AARCH64 assembly. The commit history of this project is almost the same as the original project, only the codegen part has been ported to AARCH64.

Rely on qemu-user-static to test, install it on debian:
